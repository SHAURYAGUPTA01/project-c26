...
for (var i = 0; i < playerArrows.length; i++) {
  if (playerArrows[i] !== undefined && arrow[i] !== undefined) {
    var collision = Matter.SAT.collides(arrow[i].body, playerArrows[i].body)
...
function handleComputerArrowCollision() {
  ...
  for (var i = 0; i < computerArrows.length; i++) {
    if (computerArrows[i] !== undefined && arrow[i] !== undefined) {
      var collision = Matter.SAT.collides(arrow[i].body, computerArrows[i].body)
      if (collision.collided) {
